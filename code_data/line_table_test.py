...
def test_collapse_expand(expanded, collapsed, test):
    if test == "collapse":
        assert collapse_items(expanded) == collapsed
    elif test == "expand":
        assert expand_items(collapsed) == expanded
...
def test_to_from_mapping(collapsed, mapping, max_offset, test):
    if test == "to_mapping":
        assert items_to_mapping(collapsed, max_offset) == mapping
    elif test == "from_mapping":
        assert mapping_to_items(mapping) == collapsed
